	.file	"test.c"
	.version	"01.01"
.stabs "/gaia/home/faculty/changw/www/137/lecture/Chapter04-Supplement/sample1/StructReturnTest/",100,0,0,.Ltext0
...
.stabs "stuff_t:t25=s20m:1,0,32;n:1,32,32;\\",128,0,0,0
.stabs "str:26=ar1;0;9;2,64,80;;",128,0,10,0
.section	.rodata
.LC0:
	.string	"Hello"
	.string	""
...
.text
	.align 4
.stabs "DispMsg:F25",36,0,14,DispMsg
.stabs "x:p1",160,0,13,12
.stabs "y:p1",160,0,13,16
.globl DispMsg
	.type	 DispMsg,@function
DispMsg:
.stabn 68,0,14,.LM1-DispMsg
.LM1:
	pushl %ebp
	movl %esp,%ebp
	subl $20,%esp
	...
	pushl %ebx
	movl 8(%ebp),%ebx
.stabn 68,0,15,.LM2-DispMsg
.LM2:
.LBB2:
	movl $100,-20(%ebp)   # DispMsg's stuff_t z.m = 100
	movl $200,-16(%ebp)   # DispMsg's stuff_t z.n = 200
	movl $.LC0,%eax       # DispMsg's stuff_t z.str = Hello
	movl (%eax),%edx      # addr of main's stuff_t n
	movl %edx,-12(%ebp)
	movw 4(%eax),%dx
	movw %dx,-8(%ebp)
	movb 6(%eax),%al
	...
	pushl $0
	pushl %eax             # 
	call memset            # lib call set memory (copy m n ?)
	addl $12,%esp
.stabn 68,0,17,.LM3-DispMsg
.LM3:
	movl 12(%ebp),%eax
	pushl %eax
	pushl $.LC1
...
.LM4:
	...
	call printf            # print y
	addl $8,%esp
.stabn 68,0,20,.LM5-DispMsg
.LM5:
	movl %ebx,%edi         # copy z.str (hello) to n.str
	leal -20(%ebp),%esi
	...
	jmp .L1
	.align 4
.stabn 68,0,21,.LM6-DispMsg
.LM6:
.LBE2:
.stabn 68,0,21,.LM7-DispMsg
.LM7:
.L1:
	movl %ebx,%eax
	leal -32(%ebp),%esp
...
.text
	.align 4
.stabs "main:F19",36,0,24,main
.globl main
	.type	 main,@function
main:
.stabn 68,0,24,.LM8-main
.LM8:
	pushl %ebp
	movl %esp,%ebp
	subl $28,%esp
.stabn 68,0,25,.LM9-main
.LM9:
.LBB3:
.stabn 68,0,28,.LM10-main
.LM10:
	movl $11,-4(%ebp)
.stabn 68,0,29,.LM11-main
.LM11:
	movl $22,-8(%ebp)
.stabn 68,0,30,.LM12-main
.LM12:
	leal -28(%ebp),%eax  # addr of main's stuff_t c
	movl -8(%ebp),%edx   # pass b as 2nd arg
	pushl %edx
	movl -4(%ebp),%edx   # pass a as 1st arg
	pushl %edx
	pushl %eax           # pass addr of c (to be filled)
	call DispMsg         # call DispMsg (which will fill out c)
	addl $12,%esp
.stabn 68,0,31,.LM13-main
.LM13:
	movl -24(%ebp),%eax
	pushl %eax
	pushl $.LC3
	call printf
	addl $8,%esp
.stabn 68,0,32,.LM14-main
.LM14:
.LBE3:
.stabn 68,0,32,.LM15-main
.LM15:
.L2:
	leave
	ret
.Lfe2:
	.size	 main,.Lfe2-main
.stabs "a:1",128,0,25,-4
.stabs "b:1",128,0,25,-8
.stabs "c:25",128,0,26,-28

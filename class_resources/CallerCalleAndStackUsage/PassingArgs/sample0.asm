	.file	"sample0.c"
	.version	"01.01"
.stabs "/gaia/home/faculty/changw/www/137/lecture/Chapter04-Supplement/sample0/",100,0,0,.Ltext0
.stabs "sample0.c",100,0,0,.Ltext0
.text
.Ltext0:
...
.stabs "d:p1",160,0,15,8
.stabs "e:p1",160,0,15,12
.stabs "f:p1",160,0,15,16
.globl DispMsg
	.type	 DispMsg,@function
DispMsg:
.stabn 68,0,16,.LM7-DispMsg
.LM7:
	pushl %ebp
	movl %esp,%ebp
.stabn 68,0,17,.LM8-DispMsg
.LM8:
	movl 8(%ebp),%eax
	pushl %eax
	pushl $.LC0
...
.LM10:
	...
	call printf
	addl $8,%esp
.stabn 68,0,20,.LM11-DispMsg
.LM11:
.L2:
	leave
	ret
.Lfe2:
	.size	 DispMsg,.Lfe2-DispMsg
	.text
